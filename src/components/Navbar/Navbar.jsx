...
const Navbar = () => {
    return <nav className={classes.nav}>
        ...
        <div className={`${classes.item} ${classes.users}`}><NavLink to='/users' activeClassName={classes.activeLink}>Users</NavLink></div>
        <br />
        <hr />
        <div className={`${classes.item} ${classes.settings}`}><NavLink to='/settings' activeClassName={classes.activeLink}>Settings</NavLink></div>
    </nav>
}
